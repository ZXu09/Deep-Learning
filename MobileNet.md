...
2. **平均池化**代替VGG中的全连接层，没有参数量，7 * 7 * 1024->1 * 1 * 1024
...
1. Inverted residuals（反残差），在ResNet50里我们认识到一个结构，bottleneck design结构，在3x3网络结构前利用1x1卷积降维，在3x3网络结构后，利用1x1卷积升维，相比直接使用3x3网络卷积效果更好，参数更少，**先进行压缩，再进行扩张**。
